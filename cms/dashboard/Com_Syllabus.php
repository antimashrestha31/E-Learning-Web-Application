...
<li class="nav-item">
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">BE.Computer Content</a></li>
    ...
    <section>
      <div class="d-table w-100" style="height: 150px;">
        <div class="d-table-cell align-middle text-center">
          <h1 class="font-bold text-gray-800">Manage BE.Computer Syllabus</h1>
        </div>
      </div>
    </section>
      ...
      <div class="col-md-10 mx-auto">
        <div class="card">
          <div class="card-header bg-gray-100">
            <h3 class="card-title font-bold"> <b>BE.Computer Syllabus Table</b></h3>
          </div>
          <!-- /.card-header -->

          <div class="card-body">
            <div class="table-responsive"> <!-- Added table-responsive class -->
            <form action="Com_syllabus_process.php" method="POST" class="row g-3 justify-content-center">
  <div class="col-md-6 mb-3">
    ...
    <select id="course-semester" class="form-control" name="course-semester" required>
      <optgroup label="BE-Com">
        <option value="BE-Com-Sem1">Semester 1</option>
        <option value="BE-Com-Sem2">Semester 2</option>
        <option value="BE-Com-Sem3">Semester 3</option>
        <option value="BE-Com-Sem4">Semester 4</option>
        <option value="BE-Com-Sem5">Semester 5</option>
        <option value="BE-Com-Sem6">Semester 6</option>
        <option value="BE-Com-Sem7">Semester 7</option>
        <option value="BE-Com-Sem8">Semester 8</option>
      </optgroup>
    </select>
  </div>
