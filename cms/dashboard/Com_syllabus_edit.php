...
if (isset($_GET['id'])) {
    ...
    if ($result->num_rows === 1) {
        ...
        header("Location: Com_syllabus_view.php?status=error&message=" . urlencode("Record not found."));
        exit;
    }
} else {
    header("Location: Com_syllabus_view.php?status=error&message=" . urlencode("Invalid request."));
    exit;
}
?>
...
if (isset($_POST['update'])) {
    ...
    if (!$updateStmt->execute()) {
        ...
        $updateQuery = "UPDATE syllabus SET semester = ?, subject_name = ?, subject_code = ?, credit_hour = ? WHERE id = ?";
        header("Location: Com_syllabus_view.php?semester=" . urlencode($semester));
    }
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div>
      <a href="Com_syllabus_view.php?semester=<?php echo urlencode($row['semester']); ?>" class="text-primary text-decoration-underline">Go Back</a>
      </div>
    </section>
