...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Update query
    $query = "UPDATE bit_note SET semester = ?, subject_name = ?, file_path = ? WHERE id = ?";
    ...
    if ($stmt->execute()) {
        ...
        header("Location: BIT_Note_view.php?semester=" . urlencode($semester) . "&status=success&message=" . urlencode("Record updated successfully."));
    } else {
