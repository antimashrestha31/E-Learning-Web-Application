...
if (isset($_GET['semester'])) {
    ...
    header("Location: Com_syllabus.php?status=error&message=" . urlencode("No semester specified."));
    exit;
}
?>
...
<li class="nav-item">
  <a class="nav-link" href="Logout.php" role="button" title="Logout">
    ...
    <section class="content-header">
      <div>
      <a href="Com_syllabus.php" class="text-primary text-decoration-underline">Go Back</a>
      </div>
    </section>
        ...
        <div class="card-body">
            ...
            <table class="table table-bordered w-100 text-center">
                ...
                <tr>
                    ...
                    <td>
                        <a href="Com_syllabus_edit.php?id=<?php echo urlencode($row['id']); ?>">
                            <button type="button">Edit</button>
                        </a>
                    </td>
                    <td>
                        <form action="Com_delete_syllabus.php" method="POST" onsubmit="return confirm('Are you sure you want to delete this record?');">
