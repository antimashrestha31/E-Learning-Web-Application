...
<?php include './include/B_com_db_connection.php';
    ...
    <section>
      <div class="d-table w-100" style="height: 150px;">
        <div class="d-table-cell align-middle text-center">
          <h1 class="font-bold text-gray-800">Manage BE.Computer Question</h1>
        </div>
      </div>
    </section>
      ...
      <div class="col-md-10 mx-auto">
        <div class="card">
          <div class="card-header bg-gray-100">
            <h3 class="card-title font-bold"> <b>BE.Computer Question Table</b></h3>
          </div>
          <!-- /.card-header -->
              ...
              <table class="table table-bordered w-100 text-center">
                ...
                if ($semesterResult->num_rows > 0) {
                    ...
                    while ($semesterRow = $semesterResult->fetch_assoc()) {
                        ...
                        // Subject dropdown
                        echo '<td>';
                        echo '<form action="Com_upload_question.php" method="POST" enctype="multipart/form-data">';
                        ...
                        echo '<td>';
                        echo '<div class="d-flex justify-content-center align-items-center">';
                        echo '<a href="Com_Question_view.php?semester=' . urlencode($semester) . '" style="color: white; text-decoration: none;">';
