...
if (isset($_GET['semester'])) { 
    ...
    $query = "SELECT * FROM bit_question WHERE semester = ?";
...
<tr>
    ...
    <!-- File Path -->
    <td>
        <form action="BIT_question_updated.php" method="POST" enctype="multipart/form-data">
    ...
    <!-- Delete Button -->
<td>
    <form action="BIT_delete_question.php" method="POST">
    <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
