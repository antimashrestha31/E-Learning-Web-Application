...
if (isset($_GET['semester'])) { 
    ...
    $query = "SELECT * FROM be_com_question WHERE semester = ?";
...
<li class="nav-item">
  <a class="nav-link" href="Logout.php" role="button" title="Logout">
    ...
    <section class="content-header">
      <div>
      <a href="Com_Question.php" class="text-primary text-decoration-underline">Go Back</a>
...
<tr>
    ...
    <!-- File Path -->
    <td>
        <form action="Com_question_updated.php" method="POST" enctype="multipart/form-data">
    ...
    <!-- Delete Button -->
<td>
    <form action="Com_delete_question.php" method="POST">
    <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Update query
    $query = "UPDATE be_com_question SET semester = ?, subject_name = ?, file_path = ? WHERE id = ?";
    $stmt = $conn->prepare($query);
