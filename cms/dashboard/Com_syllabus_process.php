...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result->num_rows > 0) {
        header("Location: Com_syllabus.php?status=error&message=Record+already+exists");
        ...
        if ($insertStmt->execute()) {
            ...
            header("Location: Com_Syllabus.php?status=error&message=" . urlencode("Failed to insert record."));
        }
    }
