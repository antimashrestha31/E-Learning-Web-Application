    ...
    <section>
      <div class="d-table w-100" style="height: 150px;">
        <div class="d-table-cell align-middle text-center">
          <h1 class="font-bold text-gray-800">Manage BIT Note</h1>
        </div>
      </div>
    </section>
      ...
      <div class="col-md-10 mx-auto">
        <div class="card">
          <div class="card-header bg-gray-100">
            <h3 class="card-title font-bold"> <b>BIT Note Table</b></h3>
          </div>
          <!-- /.card-header -->
            ...
            <?php
                ...
                if ($semesterResult->num_rows > 0) {
                    ...
                    while ($semesterRow = $semesterResult->fetch_assoc()) {
                        ...
                        // Subject dropdown
                        echo '<td>';
                        echo '<form action="upload_note.php" method="POST" enctype="multipart/form-data">';
                        ...
                        echo '<td>';
                        echo '<div class="d-flex justify-content-center align-items-center">';
                        echo '<a href="BIT_Note_view.php?semester=' . urlencode($semester) . '" style="color: white; text-decoration: none;">';
