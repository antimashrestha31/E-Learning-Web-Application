...
if (isset($_GET['semester'])) { 
    ...
    $query = "SELECT * FROM be_com_note WHERE semester = ?";
...
<tr>
    ...
    <!-- File Path -->
    <td>
        <form action="Com_note_updated.php" method="POST" enctype="multipart/form-data">
    ...
    <!-- Delete Button -->
<td>
    <form action="Com_delete_note.php" method="POST">
    <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
