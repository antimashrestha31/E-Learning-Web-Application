    ...
    <div class="flex justify-center space-x-6 gap-24 mb-8">
        <!-- Syllabus Button -->
         ...
         <button 
            ...
            class="btn btn-lg btn-outline-primary px-6 py-3 rounded-full transition-transform duration-300 ease-in-out transform hover:scale-110 hover:shadow-xl active" onclick="Syllabus_here()"
            >
