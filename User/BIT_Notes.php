...
$query = "SELECT semester, subject_name, file_path FROM bit_note ORDER BY semester, subject_name";
...
<section id="notes-button">
    ...
    <script>
        ...
        <button 
            class="btn btn-lg btn-outline-success px-6 py-3 rounded-full transition-transform duration-300 ease-in-out transform hover:scale-110 hover:shadow-xl active" >
